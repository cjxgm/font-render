// MODIFIED
// - removed definition of stbtt_fontinfo. the data is now in tue::font.
// + STB_TRUETYPE_IMPLEMENTATION is defined by default
// - no extern nor static, all put in unnamed namespace
// @ now is a c++14 library
// - removed STBTT_STATIC, always define STBTT_DEF to empty
// - removed packing and baking
